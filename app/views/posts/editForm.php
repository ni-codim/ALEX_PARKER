...
<div class="col-md-12 content-page">
  <div class="col-md-12 blog-post">
    ...
    <!-- Form Start -->
    <form class="edit" action="posts/<?php echo $post['postId']; ?>/<?php echo \Core\Functions\slugify($post['title']); ?>/edit/update.html" method="post">
        ...
        >
          ...
          <?php foreach ($categories as $categorie) : ?>
            <option value="<?php echo $categorie['id']; ?>"
              <?php if ($categorie['id'] == $post['categoryId']) {
